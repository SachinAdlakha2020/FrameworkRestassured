...
//extent.addSystemInfo("Environment","Environment Name")
	...
	/*
	 * @Test public static void passTest(){ //extent.startTest("TestCaseName",
	 ...
	 * 
	 * @Test public static void failTest(){ logger = extent.startTest("failTest");
	 * Assert.assertTrue(false); logger.log(LogStatus.PASS,
	 * "Test Case (failTest) Status is passed"); }
	 * 
	 * @Test public static void skipTest(){ logger = extent.startTest("skipTest");
